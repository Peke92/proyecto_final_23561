	 	...
	 	<div class="row">
	 		<div class="table-responsive">
				<table class="table table-hover">
					...
					<%
					List<Orador> resultadoOrador=null;
					OradorDAO orador=new OradorDAO();
					resultadoOrador=orador.listarOrador();
					  ...
					  <div class="modal-dialog modal-dialog-centered">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h3 class="modal-title fs-5" id="staticBackdropLabel">Eliminar</h3>
					        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					      </div>
					      <div class="modal-body">
					        <p>Está seguro de eliminar este registro? Si lo elimina ya no se podrá recuperar.</p>
					      </div>
